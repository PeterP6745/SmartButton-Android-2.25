...
import messagelogix.com.smartbuttoncommunications.model.MessageChat;

/**
 * Created by Vahid
 * This is the adapter for the messages in the conversation section
 */
public class MessageAdapter extends ArrayAdapter<MessageChat> {
    ...
    public MessageAdapter(Activity context, int resource, List<MessageChat> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MessageChat chatMessage = getItem(position);
