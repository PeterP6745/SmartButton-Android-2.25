...
/**
 * Create by Vahid
 * This is a model for a help item
 */
public class HelpModel {

    @SerializedName("data")
    @Expose
    private List<List<HelpItem>> data = new ArrayList<List<HelpItem>>();
     ...
     * @return The data
     */
    public List<List<HelpItem>> getData() {
     ...
     * @param data The data
     */
    public void setData(List<List<HelpItem>> data) {
